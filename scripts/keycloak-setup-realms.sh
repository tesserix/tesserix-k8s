...
create_customer_test_user() {
    ...
    log_success "Customer test user created: samyak.rout@gmail.com / Admin@123"
}
...
create_internal_test_user() {
    ...
    log_success "Admin test user created: samyak.rout@gmail.com / Admin@123 (super_admin)"
}
...
main() {
    ...
    echo "  Customer Portal: samyak.rout@gmail.com / Admin@123"
    echo "  Admin Portal:    samyak.rout@gmail.com / Admin@123 (super_admin)"
    echo ""
